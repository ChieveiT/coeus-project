...
function createStore(middlewares) {
  ...
  function subscribe(listener) {
    if (typeof listener !== 'function' && !(0, _isPlainObject2.default)(listener)) {
      throw new Error('Expected listener to be a function or a plain object.');
    }

    listener = hack(listener);

    currentListeners.push((0, _combineSubscribers2.default)(listener));
    ...
    previousDispatch = previousDispatch.then(function () {
      return Promise.resolve().then(function () {
        return Promise.all([currentReducer(currentState, action)]).then(function (_ref) {
          ...
          var listeners = currentListeners.slice();
          var promises = [];
